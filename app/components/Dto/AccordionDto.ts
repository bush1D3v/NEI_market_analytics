...
export const AccordionDto: Item[] = [
    {
        ...
        content:
            "O NEI Market Analytics é um projeto de pesquisa e desenvolvimento open-source para auxiliar diversos nichos de investimento, como criptomoedas, ações e notícias de mercado.",
    },
    {
        value: "item-2",
